...
- (void)showInController:(UIViewController *)viewController preferredStyle:(LHAlertControllerStyle)preferredStyle transitionAnimation:(LHAlertTransitionAnimation)transitionAnimation;

- (void)showInController:(UIViewController *)viewController preferredStyle:(LHAlertControllerStyle)preferredStyle transitionAnimation:(LHAlertTransitionAnimation)transitionAnimation backgoundTapDismissEnable:(BOOL)backgoundTapDismissEnable;
