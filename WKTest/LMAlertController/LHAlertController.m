...
@property (nonatomic, assign) LHAlertControllerStyle preferredStyle;

@property (nonatomic, assign) LHAlertTransitionAnimation transitionAnimation;
...
- (instancetype)initWithAlertView:(UIView *)alertView preferredStyle:(LHAlertControllerStyle)preferredStyle transitionAnimation:(LHAlertTransitionAnimation)transitionAnimation transitionAnimationClass:(Class)transitionAnimationClass
{
...
+ (instancetype)alertControllerWithAlertView:(UIView *)alertView
{
    return [[self alloc]initWithAlertView:alertView
                           preferredStyle:LHAlertControllerStyleAlert
                      transitionAnimation:LHAlertTransitionAnimationFade
...
+ (instancetype)alertControllerWithAlertView:(UIView *)alertView preferredStyle:(LHAlertControllerStyle)preferredStyle transitionAnimation:(LHAlertTransitionAnimation)transitionAnimation
{
    return [[self alloc]initWithAlertView:alertView
                           preferredStyle:preferredStyle
...
+ (instancetype)alertControllerWithAlertView:(UIView *)alertView preferredStyle:(LHAlertControllerStyle)preferredStyle transitionAnimationClass:(Class)transitionAnimationClass
{
    return [[self alloc]initWithAlertView:alertView
                           preferredStyle:preferredStyle
                      transitionAnimation:LHAlertTransitionAnimationCustom
...
- (void)viewDidLoad {
    ...
    if (_preferredStyle == LHAlertControllerStyleAlert) {
...
- (void)show
{
    [[LHAlertController lhFindVisibleViewControllerIsNavigationController]presentViewController:self animated:YES completion:nil];
}


+ (UIViewController *)lhFindVisibleViewControllerIsNavigationController{
