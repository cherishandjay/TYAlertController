...
@interface LHBaseAnimation : NSObject<UIViewControllerAnimatedTransitioning>
...
//  }
//  return nil;
+ (instancetype)alertAnimationIsPresenting:(BOOL)isPresenting preferredStyle:(LHAlertControllerStyle) preferredStyle;
